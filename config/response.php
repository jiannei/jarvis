...
return [
    ...
    */
    ...
    'enum' => \Jiannei\Enum\Laravel\Repositories\Enums\HttpStatusCodeEnum::class, // \Jiannei\Enum\Laravel\Repositories\Enums\HttpStatusCodeEnum::class
        ...
        [
            ...
            'data' => [
                ...
                'fields' => [
                    ...
                    'data' => ['alias' => 'items', 'show' => true], // data/rows/list
